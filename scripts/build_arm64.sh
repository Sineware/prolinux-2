#!/usr/bin/env bash
set -e
TARGET_DEVICE=postmarketos-trailblazer,pine64-pinephone,pine64-pinephonepro,pine64-pinebookpro,xiaomi-beryllium:tianma,oneplus-enchilada npm run build
